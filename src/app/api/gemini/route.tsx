import { NextRequest, NextResponse } from 'next/server';
  ...
  content: string;
  role?: "user" | "assistant" | "system"; // optional if you want to extend later
  }
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { messages: [{ content: geminiprompt }], model, temperature = 0.7, topP = 1, maxTokens = 256 } = body;
    ...
    console.log(geminiprompt, model)
    if (!geminiprompt || !model) {
